...
| [`cfDNAanalyzer`](../analyses/cfdnaanalyzer.md) | a `--cda-features` selection **and** a build cfDNAanalyzer supports (`hg19`, `hg38`, or a `cda_genome` entry naming one) |
